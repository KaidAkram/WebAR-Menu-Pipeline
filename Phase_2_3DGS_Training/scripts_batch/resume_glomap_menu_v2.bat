...
python compress_splats.py -i "%OUT_DIR%\poutin_300k\point_cloud\iteration_best\point_cloud.ply" -o "%OUT_DIR%\poutin_300k\point_cloud\iteration_best\point_cloud.splat"
